🚀 Projeto Express + EJS + PostgreSQL (pg)
Este exemplo terá a estrutura básica de um CRUD (Cadastro, Consulta, Atualização, Exclusão) para a tabela de produtos e telas adicionais para movimento de estoque e saldo. 
